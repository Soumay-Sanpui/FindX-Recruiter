        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 gap-6">
            {jobs.map((job) => (
              <div
                key={job._id}
                className="bg-white p-6 shadow-lg border border-gray-200 hover:border-blue-500 transition-all"
              >
                <div className="flex flex-col md:flex-row justify-between">
                  ...
                  <div className="md:ml-8 flex flex-col md:items-end justify-between pt-4 md:pt-0">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      <button className="bg-blue-700 text-white rounded-sm text-sm font-medium py-1 px-4 transition focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                        View Applicants
                      </button>

                      {employer.messagesAllowed && (
                        <button
                          onClick={() => navigate(`/chat/${job._id}`)} // Navigating to the chat page
                          className="bg-gray-100 text-blue-700 border border-blue-700 rounded-sm text-sm font-medium py-1 px-4 transition hover:bg-blue-50"
                        >
                          Message Me
                        </button>
                      )}
